...
function Tasks(){
    ...
    const [titlePrueba, setTitlePrueba] = useState('');
    const [descriptionPrueba, setDescriptionPrueba] = useState('');


    
    const dispatch = useDispatch();
    const dataPut = useSelector(state => state.dataSendPut);
    ...
    const handleForm = async e => {
        ...
        setTitlePrueba(dataPut.title);
        setDescriptionPrueba(dataPut.description);

        console.log(titlePrueba);
        console.log(descriptionPrueba);
            ...
            return <div class="card bg-light" key={i}>
                        ...
                        {!edit ?
                           ...
                           {/*  <button onClick={() => setData({dataName: task.name, dataDescription: task.description})} type="submit" className="btn btn-primary bg-success">Envio data</button> */}
                            <button onClick={dispatch(dataEdit({dataName: task.name, dataDescription: task.description}))} type="submit" className="btn btn-primary bg-success">Envio data</button>
